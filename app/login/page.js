...
const Login = () => {
    ...
    if (session) {
        return (
            <div className='flex flex-col justify-center items-center h-[60vh] text-white font-bold gap-4'>
                ...
                <button
                    ...
                    onClick={(e) => e.currentTarget.blur() || signOut()}
    ...
    return (
        <div className='flex flex-col justify-around items-center h-[70vh] text-white font-bold'>
            <h1 className='text-2xl'>Login To Get Chai</h1>
